...
{{% note %}}
Les version Hugo v0.15 et suivantes sont publiées sous la licence Apache 2.0.
Les versions précédentes d'Hugo ont été publiées sous une  [Licence Publique Simple](https://opensource.org/licenses/Simple-2.0).
{{% /note %}}
