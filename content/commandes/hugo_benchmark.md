...
slug: hugo_benchmark
url: /commandes/hugo_benchmark/
---
## hugo benchmark

Benchmark Hugo en construisant un site un certain nombre de fois.

### Synopsis


Hugo peut construire un site beaucoup de fois et analyse le processus en créant un benchmark.
...
Benchmark réalisé le 2017-07-21T16:49 

```bash
Average time per operation: 7209ms
Average memory allocated per operation: 841112kB
Average allocations per operation: 17311517
```
