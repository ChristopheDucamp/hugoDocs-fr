...
categories: ["Releases"]
description: "Hugo 0.23 est principalement une release qui gère toutes les petites modifications requises pour installer Hugo dans une organisation GitHub"
link: ""
title: "Release Juin"
draft: false
author: bep
...
Hugo `0.23` est principalement une release qui gère toutes les petites modifications requises pour installer Hugo dans une organisation GitHub. : [gohugoio](https://github.com/gohugoio), mais elle contient aussi quelques réparations importantes qui font que cette mise à jour est valable pour tous.

Hugo a désormais :

* 17739&#43; [stars](https://github.com/gohugoio/hugo/stargazers)
* 494&#43; [contributeurs](https://github.com/gohugoio/hugo/graphs/contributors)
* 165&#43; [thèmes](http://themes.gohugo.io/)
