...
Affiche une icône comme `{{% icon glass %}}`
...
|:--|:--|:--|
| name | **requis** | nom de l'icône (voir au-dessous) |
| size | none | taille de l'icône, medium, xx-small, x-small, small, large, x-large, xx-large, 11px, 2em, 20%.... |
